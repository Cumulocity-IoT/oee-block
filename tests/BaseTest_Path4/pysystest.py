__pysys_title__   = r""" Category Base - Base tests path Path 4 (APT, APA, QLA) """ 
#                        ================================================================================
__pysys_purpose__ = r""" """ 
...
class PySysTest(OeeBaseTest):
	...
	def execute(self):
		...
		self.sendEventStrings(correlator,
                              ...
                              self.timestamp(90),
							  self.inputEvent('pieces', 10, id=modelId),
							  ...
							  self.timestamp(330),
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces', 5, id=modelId),
							  self.inputEvent('pieces_nok', 0, id=modelId),
							  self.timestamp(360),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(390),
							  ...
							  self.timestamp(690),
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces', 2.5, id=modelId),
							  self.inputEvent('pieces_nok', 0, id=modelId),
							  self.timestamp(720),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(750),
