__pysys_title__   = r""" Category Base - Base tests path 3 (APT, AQA, QLA) """ 
#                        ================================================================================
__pysys_purpose__ = r""" """ 
...
class PySysTest(OeeBaseTest):
	...
	def execute(self):
		...
		self.sendEventStrings(correlator,
							  ...
							  self.inputEvent('pieces_ok', 10, id=modelId),
                              self.timestamp(150),
							  self.inputEvent('pieces_nok', 0, id=modelId),
							  self.inputEvent('pieces_ok', 10, id=modelId),
                              self.timestamp(210),
							  ...
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces_nok', 0, id=modelId),
							  self.inputEvent('pieces_ok', 5, id=modelId),
							  self.timestamp(360),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(390),
							  self.inputEvent('status', True, id=modelId),
							  ...
							  # Quality=50
							  self.timestamp(450),
							  self.inputEvent('pieces_nok', 5, id=modelId),
							  self.inputEvent('pieces_ok', 5, id=modelId),
							  self.timestamp(510),
							  self.inputEvent('pieces_nok', 5, id=modelId),
							  self.inputEvent('pieces_ok', 5, id=modelId),
							  ...
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces_nok', 0, id=modelId),
							  self.inputEvent('pieces_ok', 2.5, id=modelId),
							  self.timestamp(720),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(750),
							  self.inputEvent('status', True, id=modelId),
							  ...
							  self.timestamp(810),
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces_nok', 2.5, id=modelId),
							  self.inputEvent('pieces_ok', 2.5, id=modelId),
							  self.timestamp(840),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(870),
							  ...
							  self.timestamp(1050),
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces_nok', 1.25, id=modelId),
							  self.inputEvent('pieces_ok', 1.25, id=modelId),
							  self.timestamp(1080),
							  self.inputEvent('status', False, id=modelId),
							  self.timestamp(1110),
							  self.inputEvent('status', True, id=modelId),
							  ...
							  # Quality=0
							  self.timestamp(1170),
							  self.inputEvent('pieces_nok', 10, id=modelId),
