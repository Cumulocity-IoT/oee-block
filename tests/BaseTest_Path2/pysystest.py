__pysys_title__   = r""" Category Base - Base tests path 2 (APT, APA, AQA  with quality from indicator) """ 
#                        ================================================================================
__pysys_purpose__ = r""" """ 
	
__pysys_created__ = "2024-11-12"
...
class PySysTest(OeeBaseTest):
	...
	def execute(self):
		...
		self.sendEventStrings(correlator,
							  ...
							  self.timestamp(1005),
							  self.inputEvent('qok', True, id=modelId),							  
							  self.inputEvent('pieces', 1.25, id=modelId),
							  ...
							  self.inputEvent('qok', True, id=modelId),
							  self.inputEvent('status', True, id=modelId),
							  self.inputEvent('pieces', 0.0, id=modelId),
							  self.timestamp(1065),
							  self.inputEvent('qok', False, id=modelId),
							  self.inputEvent('pieces', 1.25, id=modelId),
							  self.timestamp(1080),
